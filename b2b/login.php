						...
						<div class="row">
							...
							<form action="" method="POST" onsubmit ="return false;" id="bloginform">
								...
								<div class="customer-login text-left">
									...
									<button type="submit"  id="loginbuton" onclick="loginbutton();" class="button-one
									 submit-button mt-15">Giriş Yap</button>
							...
							<form action="" method="POST" onsubmit ="return false;" id="bregisterform">
								<div class="customer-login text-left">
									...
									<button type="submit" id="registerbuton" onclick="registerbutton();"   class="button-one 
									submit-button mt-15">Kayıt Ol</button>
								</div>	
								</form>				
							</div>
