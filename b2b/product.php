...
$pimage = $db->prepare("SELECT resimurun,resimdosya,resimdurum,kapak,resimtarih FROM urun_resimler WHERE resimurun=:u  ORDER BY resimtarih  ASC");
...
<div class="<?php echo $pim['kapak'] == 1 ? 'slick-slide slick-current slick-active' : null;?>">
	<img width="370" height="450" src="<?php echo $site."/upload/product/".$pim['resimdosya'];?>" alt="<?php echo $row->urunbaslik;?>" />
