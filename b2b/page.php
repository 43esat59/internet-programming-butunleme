<?php require_once 'inc/header.php'; ?>
		...
		<?php require_once 'inc/menu.php'; ?>
			...
			<div class="heading-banner-area overlay-bg" style="background: rgba(0, 0, 0, 0) url(<?php echo site;?>/upload/<?php echo $row->kapak;?>) no-repeat scroll center center / cover;">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
